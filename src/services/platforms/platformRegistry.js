...
const DEFAULT_PLATFORM_REGISTRY = [
  {
    ...
    mock_login_description: 'Connect your Instagram account to Brandosse to schedule and publish content.',
    is_active: true,
    display_order: 1,
  },
  {
    ...
    mock_login_description: 'Connect your TikTok account to Brandosse to schedule videos.',
    is_active: true,
    display_order: 2,
  },
  {
    ...
    mock_login_description: 'Connect your YouTube channel to Brandosse to publish videos.',
    is_active: true,
    display_order: 3,
  },
  {
    ...
    mock_login_description: 'Connect your Facebook Page to Brandosse to manage and schedule posts.',
    is_active: true,
    display_order: 4,
  },
  {
    ...
    mock_login_description: 'Connect your LinkedIn profile or company page to Brandosse.',
    is_active: true,
    display_order: 5,
  },
  {
    ...
    mock_login_description: 'Connect your X account to Brandosse to schedule tweets.',
    is_active: true,
    display_order: 6,
  },
  {
    ...
    mock_login_description: 'Connect your Pinterest account to Brandosse to schedule pins.',
    is_active: true,
    display_order: 7,
  },
  {
    ...
    mock_login_description: 'Connect your Threads account to Brandosse to schedule posts.',
    is_active: true,
    display_order: 8,
  },
];
