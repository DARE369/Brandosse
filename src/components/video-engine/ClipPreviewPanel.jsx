...
// Hook score gets a ring instead of a bar — it's the single strongest
// predictor of whether a clip gets watched, so it earns a distinct shape
// rather than blending into the Flow/Value/Trend bar stack below it.
...
export default function ClipPreviewPanel({ clip, onRefreshUrl, savedAssetId = null, onSaved }) {
      ...
      <div style={{ flex: 1, display: "flex", minHeight: 0, overflow: "hidden" }}>
        ...
        */}
        ...
        <div style={{
          ...
          {/* Score breakdown — Hook gets a ring, the rest stay bars */}
